...
Generated: 2026-09-07 15:22:00 +02:00
...
| Status | Check | Details |
|---|---|---|
| PASS | Managed solution builds | exit 0;   FIP.RobCo.Harmony -> C:\Users\Matthias\Desktop\Fallout Immersion Project\FIP-RobCo\LoadFolders\Harmony\Assemblies\FIP_RobCo_Harmony.dll   FIP.WestTek.Harmony -> C:\Users\Matthias\Desktop\Fallout Immersion Project\FIP-WestTek\LoadFolders\Harmony\Assemblies\FIP_WestTek_Harmony.dll  Der Buildvorgang wurde erfolgreich ausgeführt.     0 Warnung(en)     0 Fehler  Verstrichene Zeit 00:00:00.81 |

## Collisions

| Status | Check | Details |
|---|---|---|
| PASS | No cross-module direct Def identities | 1265 direct defs; 0 collisions |
| PASS | No cross-module English language keys | 3688 entries; 0 collisions |
| PASS | No cross-module concrete XPath plus field targets | 8019 target signatures; 0 collisions |
| PASS | Only documented root-XPath overlaps remain | /Defs; Defs/FactionDef[defName="Ancients"]; Defs/FactionDef[defName="AncientsHostile"] |

## Ideology

| Status | Check | Details |
|---|---|---|
| PASS | Only originally suppressed VMemesE origins are settings-controlled | Serketist/SecularSpirituality only, with reversible hide/zero-weight application and curated faction fallback: True; Def deletion absent, retained preset references: 6; retained language keys: 18 |
...
| Status | Check | Details |
|---|---|---|
| PASS | All content filters use positive immersive-only defaults and labels | immersive-only defaults: 25; labels: 25; Restore labels: 0 |
| PASS | Every option explains how to restore content and states its default | 25 of 25 descriptions use plain restore/default wording |
| PASS | Def-dependent runtime work is deferred; Arktos and WestTek gate source XML | 7 deferred settings initializers; Arktos and WestTek use load-time gates |
