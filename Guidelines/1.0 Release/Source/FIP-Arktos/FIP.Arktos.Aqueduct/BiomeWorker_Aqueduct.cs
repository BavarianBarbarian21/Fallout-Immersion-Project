...
public sealed class BiomeWorker_Aqueduct : BiomeWorker
{
    ...
    private const float HugeRiverChance = 0.98f;
    private const float LargeRiverChance = 0.80f;
    private const float MediumRiverChance = 0.45f;
    private const float SmallRiverChance = 0.18f;
    ...
    private static RiverSize GetRiverSize(Tile tile)
    {
        ...
        var riverLinks = GetRiverLinks(surfaceTile);
