...
public static class SyntheticPawnUtility
{
    private const string Gen1BodyPath = "FIP-RobCo/Robots/Synth/Gen1/RobCo_SynthT1";
    private const string Gen2BodyPath = "FIP-RobCo/Robots/Synth/Gen2/RobCo_SynthT2_body_Male";
    private const string Gen2HeadPath = "FIP-RobCo/Robots/Synth/Gen2/RobCo_SynthT2_head_Male";
    private const string ThinkTankPath = "FIP-RobCo/Robots/ThinkTank/RobCo_Thinktank";
    ...
    {
        return HasActiveGene(pawn, RobCoDefOf.RobCo_Gene_SynthBody);
    }
