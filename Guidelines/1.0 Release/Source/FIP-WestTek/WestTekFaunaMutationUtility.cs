...
public static class WestTekFaunaMutationUtility
{
    ...
    {
        return pawn?.genes?.Xenotype == WestTekDefOf.WestTek_Xenotype_SNuffy;
    }
    ...
    public static bool IsGeneratedFaunaXenotype(XenotypeDef xenotype)
    {
        ...
        return xenotype == WestTekDefOf.WestTek_Xenotype_SLanter
            || xenotype == WestTekDefOf.WestTek_Xenotype_SNuffy
    ...
    public static void TransformSLanterIntoSNuffy(Pawn pawn)
    {
        ...
        pawn.genes.SetXenotype(WestTekDefOf.WestTek_Xenotype_SNuffy);
