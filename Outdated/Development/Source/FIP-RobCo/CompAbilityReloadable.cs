...
public class CompAbilityReloadable : ThingComp
{
    public override IEnumerable<FloatMenuOption> CompFloatMenuOptions(Pawn selPawn)
    {
        ...
        string label = "RobCo_ReloadMechAbility".Translate(mech.LabelShort, reloadableAbility.Props.ammoDef.label);
        yield return FloatMenuUtility.DecoratePrioritizedTask(
            new FloatMenuOption(label, delegate
            {
                Job job = JobMaker.MakeJob(JobDefOf_FIPRobCo.RobCo_ReloadMechAbility, mech);
